...
RestoreGfxBlock:
{
    ...
    ; ;LDX.w #$3981 : STX $4300 ; set dma to read word mode, set src register $2139
    ; LDX.w #$1801 : STX $4300 ; set dma to write word mode, set dest register $2118
    ; LDX.w #$7667 : STX $4302 ; src address
    ; LDA.b #$7F   : STA $4304 ; src bank
    ; LDX.w #$1000 : STX $4305 ; length
    ; LDA.b #$01   : STA $420B ; start dma
    ; LDA.b #$80   : STA $2100 ; vblank
